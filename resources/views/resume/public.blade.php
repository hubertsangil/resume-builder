...
<body>
  ...
  <div class="profile">
    <img src="{{ asset('assets/images/profile.png') }}" alt="Profile Picture" class="profile-pic">
    <div class="profile-info">
      ...
      <div class="contact-info">
        ...
        <div class="contact-buttons">
          ...
          @endif
          @if(!empty($resume_pdf_url))
          <a href="{{ $resume_pdf_url }}" download class="resume-button">
            Download Resume
          </a>
          @endif
        </div>
    ...
    <section class="experience">
      ...
      <ul class="timeline">
        @foreach ($experience as $exp)
          <li @if($exp['current'] ?? false) class="current" @endif>
    ...
    <section class="education">
      ...
      <ul class="timeline">
        @foreach ($education as $edu)
          <li @if($edu['current'] ?? false) class="current" @endif>
            <div class="timeline-content">
              <div class="timeline-meta">
